    ...
    <>
      ...
      >
        <div style={{height: '64px', display: 'flex', alignItems: 'center', gap: '10px', padding: '0 var(--spacing-6)', borderBottom: '1px solid var(--neutral-50)', backgroundColor: 'var(--primary-50)'}}>
          ...
          <span style={{fontSize: '1.6rem', fontWeight: '900', color: 'var(--primary-600)', letterSpacing: '0.04em', fontStyle: 'italic', display: 'inline-block', transform: 'scaleX(1.15)', transformOrigin: 'left'}}>Billify</span>
        </div>
