...
class PaymentMethodChart extends StatelessWidget {
      ...
      children: [
        ...
        Expanded(
          ...
          child: Column(
            ...
            children: data.map((e) => _LegendItem(
              label: e.method,
  ...
  Color _getColor(int i) {
    final colors = [AppTheme.primaryTeal, Colors.orange, Colors.purple, Colors.blue, Colors.green];
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          Text('$percent%', style: TextStyle(fontSize: 11, color: Theme.of(context).hintColor)),
        ],
      ),
    );
  }
